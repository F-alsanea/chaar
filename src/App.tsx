    ...
    fetch('/api/properties')
      ...
      .then(data => {
        if (data.length > 0) {
          ...
          // Handle shared property ID
          const propertyId = searchParams.get('id');
          if (propertyId) {
            const shared = data.find((p: Property) => p.id === propertyId);
            if (shared) {
              setSelectedProperty(shared);
              // Scroll to the property view if needed, or just let the modal open
            }
          }
        }
      })
            ...
            >
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="px-8 py-4 bg-indigo-600 dark:bg-indigo-500 text-white rounded-xl font-bold hover:bg-indigo-700 dark:hover:bg-indigo-600 transition-all shadow-lg shadow-indigo-200 dark:shadow-none flex items-center gap-2"
                >
                  <span>ابحث الآن</span>
                  <ArrowRight size={18} />
                </button>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="h-[450px]">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3707.1706684024344!2d39.1092892!3d21.7114631!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x15c3d972776c59d9%3A0xe54d6ea61bface66!2z2LTYudCw2LEg2KfZhNi52YLZitCw2LHZitip!5e0!3m2!1sar!2ssa!4v1708684000000!5m2!1sar!2ssa"
                width="100%"
                height="100%"
                style={{ border: 0 }}
            ...
            <div className="flex items-center justify-between p-5 bg-white dark:bg-slate-900 border-t border-slate-100 dark:border-slate-800">
              ...
              <a
                href="https://maps.app.goo.gl/ffVjV5MHL8VWo2ms7"
                target="_blank"
...
function Layout({ children }: { children: React.ReactNode }) {
  ...
  const handleFooterContact = (e: React.MouseEvent) => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white dark:bg-slate-950 transition-colors duration-300">
      ...
      <AnimatePresence>
        {showContactPopup && (
          <div className="fixed inset-0 z-[60] flex items-end sm:items-center justify-center p-4 bg-black/60 backdrop-blur-sm" onClick={() => setShowContactPopup(false)}>
            <motion.div
              initial={{ y: "100%" }}
              animate={{ y: 0 }}
              exit={{ y: "100%" }}
              className="bg-white dark:bg-slate-900 w-full max-w-sm rounded-t-[32px] sm:rounded-[32px] p-8 shadow-2xl border dark:border-slate-800"
              onClick={(e) => e.stopPropagation()}
            >
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-xl font-bold text-slate-900 dark:text-white">اتصل بنا</h3>
                <button onClick={() => setShowContactPopup(false)} className="p-2 bg-slate-100 dark:bg-slate-800 rounded-full text-slate-500">
                  <X size={20} />
                </button>
              </div>
              <div className="grid grid-cols-1 gap-4">
                <a
                  href="tel:0544137950"
                  className="flex items-center justify-center gap-3 p-5 bg-indigo-600 text-white rounded-2xl font-bold hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-200 dark:shadow-none"
                >
                  <Phone size={24} />
                  <span>اتصال مباشر</span>
                </a>
                <a
                  href={`https://wa.me/966544137950?text=${encodeURIComponent('السلام عليكم شعار العقارية حاب استفسر عن...')}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-3 p-5 bg-emerald-600 text-white rounded-2xl font-bold hover:bg-emerald-700 transition-all shadow-lg shadow-emerald-200 dark:shadow-none"
                >
            ...
            <div>
              ...
              <ul className="space-y-4 text-slate-500 dark:text-slate-400">
                ...
                <li>
                  <a
                    href="tel:0544137950"
                    onClick={handleFooterContact}
                    className="flex items-center gap-3 hover:text-indigo-600 dark:hover:text-white transition-colors"
                  >
                    <Phone size={18} className="text-indigo-500" />
